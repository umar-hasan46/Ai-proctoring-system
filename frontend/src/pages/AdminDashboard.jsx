...
function AdminDashboard({ user }) {
  ...
  const StatCard = ({ label, value, color }) => (
    <div className="card" style={{ textAlign: 'center', borderTop: `4px solid ${color}` }}>
      <h4 style={{ color: '#718096', margin: 0, fontSize: '0.85rem', textTransform: 'uppercase' }}>{label}</h4>
  ...
  return (
    <div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '1.5rem', marginBottom: '1.5rem' }}>
        <StatCard label="Total Users" value={stats.total_users} color="#1e3a5f" />
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }}>
        <div className="card">
          ...
          <div>
            ...
            <div style={{ height: '20px', background: '#e2e8f0', borderRadius: '10px', overflow: 'hidden', marginBottom: '1rem' }}>
